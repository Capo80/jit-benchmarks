...
no_mod_times = pd.read_csv("jit_results_no_mod_full.csv")
no_sync_times = pd.read_csv("jit_results_no_sync_full.csv")
sync_times = pd.read_csv("jit_results_sync_full.csv")

times = [0]*3
#times[0] = no_mod_times.loc[(no_mod_times["Language"] == GRAPH_TYPE) & (no_mod_times["Test Name"] != "spectralnorm")]
#times[1] = no_sync_times.loc[(no_sync_times["Language"] == GRAPH_TYPE) & (no_sync_times["Test Name"] != "spectralnorm")]
#times[2] = sync_times.loc[(sync_times["Language"] == GRAPH_TYPE)  & (sync_times["Test Name"] != "spectralnorm")]
