...
# RES_FOLDER = "save_1/"
# RES_FOLDER = "save_2/"
# RES_FOLDER = "1697115367_test/"
RES_FOLDER = "1697182227_test/"
colors = ["#03045e", "#023e8a", "#0077b6", "#0096c7", "#00b4d8", "#48cae4", "#90e0ef"]

#################### only change this #########################

# no_mod_times = pd.read_csv(RES_FOLDER + "jit_results_no_mod_full.csv")
# no_sync_times = pd.read_csv(RES_FOLDER + "jit_results_no_sync_full.csv")
# sync_times = pd.read_csv(RES_FOLDER + "jit_results_sync_full.csv")
...
times = [0]*3
# times[0] = no_mod_times.loc[(no_mod_times["Language"] == GRAPH_TYPE) & (no_mod_times["Test Name"] != "spectralnorm") & (no_mod_times["Test Name"] != "binarytrees")]
# times[1] = no_sync_times.loc[(no_sync_times["Language"] == GRAPH_TYPE) & (no_sync_times["Test Name"] != "spectralnorm") & (no_mod_times["Test Name"] != "binarytrees")]
# times[2] = sync_times.loc[(sync_times["Language"] == GRAPH_TYPE)  & (sync_times["Test Name"] != "spectralnorm") & (no_mod_times["Test Name"] != "binarytrees")]

times[0] = no_mod_times.loc[(no_mod_times["Language"] == GRAPH_TYPE)]
times[1] = no_sync_times.loc[(no_sync_times["Language"] == GRAPH_TYPE)]
times[2] = sync_times.loc[(sync_times["Language"] == GRAPH_TYPE)]
...
x_name = "Test Name"
labels = ["No LKM", "LKM with no sync", "LKN with sync"]     
ys = []
